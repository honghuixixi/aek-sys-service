...
public class BaseDictServiceImpl extends BaseServiceImpl<BaseDictMapper, BaseDict> implements BaseDictService {
	...
	public void edit(BaseDict baseDict) {
		...
		this.updateById(baseDict);
		if(StringUtils.isBlank(baseDict.getRemarks())){
			BaseDict remarksBaseDict = this.selectById(baseDict.getId());
			remarksBaseDict.setRemarks(null);
			baseDictMapper.updateAllColumnById(remarksBaseDict);
		}
	}
